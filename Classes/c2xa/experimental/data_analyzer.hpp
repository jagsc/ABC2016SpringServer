                ...
                if( ( cnt_ %= 10 ) == 0 )
                {
                    ...
                    if( draw_ && analyzer_ )
                    {
                        ...
                        if( list_.size() > 1 )
                        {
                            ...
                            {
                                double data_[ data_analyzer::sample ];
                                ...
                                for( int i = 0; i < data_analyzer::sample; ++i )
                                {
                                    ...
                                    data_[ i ] = static_cast<double>( std::get<0>( *it_ ).x )
                                        * ( 0.54 - 0.46 * std::cos( 2 * M_PI * i / data_analyzer::sample ) ); // hamming window
                                    ++it_;
                                }
                                ...
                                {
                                    draw_->drawSegment(
                                        Vec2{ c * app_width / data_analyzer::sample, 0 },
                                        Vec2{ c * app_width / data_analyzer::sample, static_cast<float>( d ) },
